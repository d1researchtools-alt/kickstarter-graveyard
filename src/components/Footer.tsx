...
interface FooterProps {
  ...
  topPosition?: string; // Custom top position for absolute positioning
}
...
export default function Footer({ positioning = 'absolute', topPosition = '100vh' }: FooterProps) {
  const footerLinks = {
    ...
    toolsResources: [
      { label: 'Product Development Budget', href: 'https://ai.design1st.com/budget-tool' },
      { label: 'Find Funding Tool', href: 'https://ai.design1st.com/funding-tool' },
      { label: 'Visit Our Knowledge Hub', href: 'https://ai.design1st.com/' },
    ...
    >
      ...
      <div className="bg-gray-200">
        <div className="px-6 sm:px-8 md:px-16 lg:px-16 xl:px-[120px] pt-4 md:pt-5 lg:pt-6 pb-6 md:pb-8 lg:pb-10 flex justify-center">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap lg:flex-nowrap gap-6 lg:gap-6 xl:gap-12 justify-center">
            {/* Expertise Column */}
            ...
            {/* About Column */}
            <div className="flex flex-col gap-4">
              <h3 className="text-base font-semibold text-[#111111] border-b border-[#111111] pb-1 whitespace-nowrap">
                About Design 1st
              </h3>
              <ul className="flex flex-col gap-[13px]">
        ...
        <div className="px-6 sm:px-8 md:px-16 lg:px-[120px] py-3 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4 items-center">
            {socialLinks.map((social) => {
              // Instagram and X are smaller (17px), others are 24px
